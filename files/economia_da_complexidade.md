Eu já fiz alguns comentários sobre a [filosofia da econofísica](https://github.com/jdansb/Econophysics/blob/main/files/Filosofia%20da%20Econof%C3%ADsica.md), e alguns comnentários sobre a [economia monetária de uma perspectiva da econofisica](https://github.com/jdansb/Econophysics/blob/main/files/monetary.ipynb), agora eu quero fazer alguns comentários de um economista sobre a econofísica, para isso eu vou me basear na obra [Economia da Complexidade](https://fernandonogueiracosta.wordpress.com/wp-content/uploads/2024/09/fernando-nogueira-da-costa-economia-da-complexidade-ou-econofisica-ago-2024.pdf).

A vanguarda teórica dos economistas deseja desenvolver uma Física Social de modo que ela amplie o pensamento socioeconômico e político, incluindo não apenas forças competitivas, mas também trocas de
ideias, informações, pressão em busca de status social etc. a fim de explicar melhor o comportamento humano coletivo. Ela busca explicar como as interações sociais geram a auto-organização dinâmica da economia como um sistema complexo.

Busca entender como das interações sociais dos componentes do sistema, desde os agentes até a comunidade, o mercado e o Estado, emerge uma sociedade conectada em rede.  As premissas neo clássicas propõem indivíduos “atomizados” , racionais, dotados de informações perfeitas (e não privilegiadas), para a maximização de todos. Assim, na economia ortodoxa, a “regra” é o reducionismo atomístico, no qual a realidade deve ser explicada em termos de um agente representativo racional. Os economistas ortodoxos partem do princípio de o comportamento agregado de um sistema ser idêntico à soma dos efeitos de cada uma das causas individuais.
